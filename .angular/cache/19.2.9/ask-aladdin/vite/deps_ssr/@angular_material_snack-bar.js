...
var MatSnackBarRef = class {
  constructor(containerInstance, _overlayRef) {
    ...
    this._afterDismissed = new import_rxjs8.Subject();
    this._afterOpened = new import_rxjs8.Subject();
    this._onAction = new import_rxjs8.Subject();
...
var MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  constructor(_ngZone, _elementRef, _changeDetectorRef, _platform, snackBarConfig) {
    ...
    this._onAnnounce = new import_rxjs8.Subject();
    this._onExit = new import_rxjs8.Subject();
    this._onEnter = new import_rxjs8.Subject();
