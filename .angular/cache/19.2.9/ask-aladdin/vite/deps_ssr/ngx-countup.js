...
// node_modules/ngx-countup/fesm2015/ngx-countup.mjs
var CountUpDirective = class {
  ...
  ngOnChanges(changes) {
    ...
    if (this.countUp) {
      if ((options === null || options === void 0 ? void 0 : options.currentValue) !== void 0 || (endVal === null || endVal === void 0 ? void 0 : endVal.currentValue) !== void 0) {
        if ((options === null || options === void 0 ? void 0 : options.currentValue) !== void 0) {
          this.initAndRun();
        } else {
